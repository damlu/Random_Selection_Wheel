import _toConsumableArray from "/Users/danielmoisoff/Documents/coding/randostreams/randostream_app/node_modules/@babel/runtime/helpers/esm/toConsumableArray";
...
import _assertThisInitialized from "/Users/danielmoisoff/Documents/coding/randostreams/randostream_app/node_modules/@babel/runtime/helpers/esm/assertThisInitialized";
...
function (_React$Component) {
  ...
  function SpinningWheel(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SpinningWheel).call(this, props));
    _this.startSpin = _this.startSpin.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(SpinningWheel, [{
    ...
    value: function properNumberOfSources(sources) {
      ...
      while (currentValues.length < this.state.numberOfSources) {
        currentValues = _toConsumableArray(currentValues).concat(_toConsumableArray(currentValues));
      }
    ...
    value: function getWedges() {
      ...
      if (typeof this.state.sources === "function") {
        return this.state.sources().then(function (payload) {
          ...
          if (currentValues.length < _this2.state.numberOfSources || currentValues.length > _this2.state.numberOfSources) {
        ...
        var newOrder = this.createShuffleObj(Object.values(this.state.wedgeSources));
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (!this.state.firstSpin && !this.state.updateWheel && prevState.result !== this.state.result) {
        this.startSpin();
      } else if (prevState.result !== this.state.result && this.state.showWedges && this.state.spinning) {
        this.startSpin();
    ...
    value: function circleStyle() {
      if (!this.state.setToZero) {
        return {
          ...
          boxShadow: "0px 0px 0px 12px\n        ".concat(this.props.outerRingColor),
          transform: "translate(-50%, 0%) rotate(".concat(this.state.spinBy, "deg)"),
    ...
    value: function render() {
      ...
      var pointerColor = this.props.outerRingColor ? {
        borderColor: "".concat(this.props.outerRingColor, " transparent transparent")
      } : {
        borderColor: "white transparent transparent"
      };
      var displayResult = this.state.loadInResult && this.state.result ? React.createElement("div", {
        style: displayResultStyle,
        className: "displayResult"
      }, this.props.displayResult(this.state.result)) : null;
      var displayWedges = this.state.showWedges ? React.createElement(Wedges, {
      ...
      return React.createElement(Fragment, null, React.createElement("div", {
        className: "min"
      }, displayResult, React.createElement("div", {
        style: pointerColor,
        className: "pointer"
